...
3. Give an Account Name to QuickSight service. You might use "dev-lab" as shown in screenshot. Then leave all other options as default settings, and click "Finish" to finalise the QuickSight sign up process.
